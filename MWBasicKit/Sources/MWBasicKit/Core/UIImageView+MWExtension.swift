...
@objc public protocol MWImageViewStreamProtocol {
    
}

public extension MWImageViewStreamProtocol where Self: UIImageView {
    // default is nil
    @discardableResult
    ...
    // default is nil
    @available(iOS 3.0, *) @discardableResult
...
@objc extension UIImageView: MWImageViewStreamProtocol {
